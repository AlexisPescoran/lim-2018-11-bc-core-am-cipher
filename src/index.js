...
const seeInstructions = () => {
  document.getElementById("l1").innerHTML="* Esta web es una herramienta para que puedas ocultar los nombres de tus amigos";
  document.getElementById("l2").innerHTML="* Si quieres ocultar la lista de los participantes, dale click en &quotcubrir&quot para ocultar la lista de participantes";
  document.getElementById("l3").innerHTML="* Si quieres descubrir quien es tu amigo secreto, dale click en &quotdescubrir&quot para que sepas quien es el elegido"
}
